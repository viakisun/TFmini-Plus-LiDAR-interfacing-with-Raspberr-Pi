...
class SettingPage(tk.Frame):
    def __init__(self, parent, controller, background_img):
        ...
        self.imgBtnUp = tk.PhotoImage(file='/home/pi/devwork/nsc/nsc_rp/images/btnUp.png')
        self.imgBtnDown = tk.PhotoImage(file='/home/pi/devwork/nsc/nsc_rp/images/btnDown.png')
